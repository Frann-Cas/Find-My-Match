...
const SPORTS = ['🎾 Tennis','🏓 Padel','🏓 Pickleball','🏀 Basketball','⚽ Soccer','🏐 Volleyball']
  ...
  return (
    <div style={{background:'#0A0000',minHeight:'100vh'}}>
      ...
      <div style={{padding:'70px 24px 60px',textAlign:'center',maxWidth:'520px',margin:'0 auto',position:'relative'}}>
        ...
        <p style={{color:'#757070',fontSize:'15px',lineHeight:1.7,marginBottom:'40px',fontFamily:'DM Sans,sans-serif'}}>
      ...
      <div style={{padding:'50px 24px 60px',maxWidth:'480px',margin:'0 auto'}}>
        ...
        {[
          ['01','Post Your Match','Set sport, time, location & pay rate. Goes live to referees instantly.','#F63676'],
          ['02','Referee Accepts','A certified ref nearby accepts your job in seconds.','#757070'],
          ['03','Watch Live','Share a link. Anyone follows every point in real time.','#EDFF00'],
        ].map(([n,t,d,c])=>(
